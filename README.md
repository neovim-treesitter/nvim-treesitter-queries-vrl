# nvim-treesitter-queries-vrl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-vrl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-vrl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **vrl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-vrl",
...
- [ ] Changes are scoped to `vrl` — do not include files for other languages
